...
DATA(insert OID = 6036 ( pg_dist_wait_status  PGNSP PGUID 12 1 1000 0 0 f f f f f t v 0 0 2249 "" "{23,28,28,16}" "{o,o,o,o}" "{segid,waiter_dxid,holder_dxid,holdTillEndXact}" _null_ pg_dist_wait_status _null_ _null_ _null_ n a ));
...
/* gp_fdw_acquire_sample_rows(oid, int4, text) => SETOF record */
DATA(insert OID = 6083 ( gp_fdw_acquire_sample_rows  PGNSP PGUID 12 1 1000 0 0 f f f f f t v 3 0 2249 "26 23 25" _null_ _null_ _null_ _null_ gp_fdw_acquire_sample_rows _null_ _null_ _null_ n s ));
