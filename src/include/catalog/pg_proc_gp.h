...
DATA(insert OID = 6083 ( gp_fdw_acquire_sample_rows  PGNSP PGUID 12 1 1000 0 0 f f f f f t v 3 0 2249 "26 23 25" _null_ _null_ _null_ _null_ gp_fdw_acquire_sampe_rows _null_ _null_ _null_ n s ));
